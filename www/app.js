...
var $author$project$View$footer = $aramiscd$gren_hyper$Hyper$children$([ $aramiscd$gren_hyper$Hyper$children$([ $aramiscd$gren_hyper$Hyper$children$([ $aramiscd$gren_hyper$Hyper$text('Quelltext') ], A2($aramiscd$gren_hyper$Hyper$href, 'https://github.com/aramiscd/pwgen.nojs.de/', $aramiscd$gren_hyper$Hyper$a)) ], $aramiscd$gren_hyper$Hyper$div), $aramiscd$gren_hyper$Hyper$children$([ $aramiscd$gren_hyper$Hyper$children$([ $aramiscd$gren_hyper$Hyper$text('Lizenz') ], A2($aramiscd$gren_hyper$Hyper$href, 'https://raw.githubusercontent.com/aramiscd/pwgen.nojs.de/master/LICENSE', $aramiscd$gren_hyper$Hyper$a)) ], $aramiscd$gren_hyper$Hyper$div), $aramiscd$gren_hyper$Hyper$children$([ $aramiscd$gren_hyper$Hyper$children$([ $aramiscd$gren_hyper$Hyper$text('Vertrauen') ], A2($aramiscd$gren_hyper$Hyper$href, 'https://github.com/aramiscd/pwgen.nojs.de/blob/master/vertrauen.md', $aramiscd$gren_hyper$Hyper$a)) ], $aramiscd$gren_hyper$Hyper$div) ], A2($aramiscd$gren_hyper$Hyper$class, 'flex gap-7 pt-7 text-xs text-gray-500', $aramiscd$gren_hyper$Hyper$div));
